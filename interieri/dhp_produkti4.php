...
<body>
    ...
    <main>
        <div class="dhp_produkt4">
            <img id="dhp_produkti4" class="zoomin" src="../../images/imgdhpunes/longtable.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12348p</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Kalani</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">There will be enough space on your table now. </td>
                    </tr>
                    <tr>
