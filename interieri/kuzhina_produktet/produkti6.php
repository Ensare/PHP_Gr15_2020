...
<body>
    ...
    <main>
        ...
        <div class="kuzhina_produkti6">
            <img id="kuzhina_produkti6" class="zoomin" src="../../images/imgkuzhina/kitchen2.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">85557f</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Beskope Kitchen</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">2000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">My kitchen is for dancing.</td>
                    </tr>
                    <tr>
