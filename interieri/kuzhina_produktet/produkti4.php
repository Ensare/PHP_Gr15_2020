...
<body>
    <header>
        ...
        <div class="kuzhina_produkti4">
            <img id="kuzhina_produkti4" class="zoomin" src="../../images/imgkuzhina/d.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12345d</td class="pad">
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Calgary Kitchen</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">1300$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Meals and Memories are made here.</td>
                    </tr>
                    <tr>
