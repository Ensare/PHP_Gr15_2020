...
<body>
    ...
    <main>
        ...
        <div class="kuzhina_produkti5">
            <img id="kuzhina_produkti5" class="zoomin" src="../../images/imgkuzhina/e.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">45687e</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Fitted Kitchen</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">1700$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">This kitchen is seasoned with love.</td>
                    </tr>
                    <tr>
