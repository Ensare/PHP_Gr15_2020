...
<body>
    ...
    <main>
        ...
        <div class="kuzhina_produkti2">
            <img id="kuzhina_produkti2" class="zoomin" src="../../images/imgkuzhina/b.jpg" style="width: 490px; height:350px">
            <table border="1" class="tabela" >
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">32145b</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Kingsey Kitchen</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">1200$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">My kitchen was clean last week.</td class="pad">
                    </tr>
                    <tr>
