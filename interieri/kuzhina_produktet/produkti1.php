...
<body>
    ...
    <main>
        ...
        <div class="kuzhina_produkti1">
            <img id="kuzhina_produkti1" class="zoomin" src="../../images/imgkuzhina/a.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">33987a</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Kitchen Reno</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">1000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Feel comfy with the blue kitchen </td>
                    </tr>
                    <tr>
