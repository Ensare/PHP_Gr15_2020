...
<body>
    ...
    <main>
<div class="dhgj_produkti4">
    <img id="dhgj_produkti4" class="zoomin" src="../../images/imggjumi/dhgj4.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
        <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12563d</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Wayfair</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">Let's stay in bed. </td>
                    </tr>
                    <tr>
