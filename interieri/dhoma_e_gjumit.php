    ...
    <main>
        ...
        <section id="vid">
            <video width="520" height="440" controls>
                <source src="../video/dhgjumitvid.mp4" type="video/mp4">
            </video>
            <style>
                #vid {
                    margin: 1% 25%;
