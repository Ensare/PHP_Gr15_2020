...
<body>
    ...
    <main>
        ...
        <section class="produktet_dh_punes">
            <a href="dhoma_punes_produktet/dhp_produkti1.php">
                <img id="dh_produkt1" class="hoveer" src="../images/imgdhpunes/fotele.jpg" style="width: 400px; height: 271px"></a>

            <a href="dhoma_punes_produktet/dhp_produkti2.php">
                <img id="dh_produkt2" class="hoveer" src="../images/imgdhpunes/bigworktable.jpg" style="width: 400px; height: 271px"></a>

            <a href="dhoma_punes_produktet/dhp_produkti3.php">
                <img id="dh_produkt3" class="hoveer" src="../images/imgdhpunes/beanbags.jpg" style="width: 400px"></a>

            <a href="dhoma_punes_produktet/dhp_produkti4.php">
                <img id="dh_produkt4" class="hoveer" src="../images/imgdhpunes/longtable.jpg" style="width: 400px; height: 271px"></a>

            <a href="dhoma_punes_produktet/dhp_produkti5.php">
                <img id="dh_produkt5" class="hoveer" src="../images/imgdhpunes/room.jpg" style="width: 400px; height: 271px"></a>

            <a href="dhoma_punes_produktet/dhp_produkti6.php">
                <img id="dh_produkt6" class="hoveer" src="../images/imgdhpunes/shelf.jpg" style="width: 400px; height: 271px"></a>
