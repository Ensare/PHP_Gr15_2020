...
<body>
    ...
    <main>
<div class="dhd_produkti5">
    <img id="dhd_produkti5" class="zoomin" src="../../images/imgdhdites/dhd_produkti5.png" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
        <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">68239f</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Wystfield</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">20000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Home is where you hang your heart. </td>
                    </tr>
                    <tr>
