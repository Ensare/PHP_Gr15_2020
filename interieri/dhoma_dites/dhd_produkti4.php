...
<body>
    ...
    <main>
<div class="dhd_produkti4">
    <img id="dhd_produkti4" class="zoomin" src="../../images/imgdhdites/dhd_produkti4.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
        <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12349d</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Schofield</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">7500$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Everyone brings joy to this House. </td>
                    </tr>
                    <tr>
