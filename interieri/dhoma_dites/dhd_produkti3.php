...
<body>
    ...
    <main>
<div class="dhd_produkti3">
 <img id="dhd_produkti3" class="zoomin" src="../../images/imgdhdites/dhd_produkti3.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
       <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">82584c</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Giunta Wool</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">13000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Be our guest, stay a while. </td>
                    </tr>
                    <tr>
