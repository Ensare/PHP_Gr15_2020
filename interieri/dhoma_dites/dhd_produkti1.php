...
<body>
    ...
    <main>
        <div class="dhd_produkti1">
            <p></p>
            <img id="dhd_produkti1" class="zoomin" src="../../images/imgdhdites/dhd_produkti1.png"
                style="width: 490px; height: 350px">
            <table border="1" class="tabela" cellspacing="2">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">10767a</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Natalia</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">Excuse the mess but we live here. </td>
                    </tr>
                    <tr>
