...
<body>
    ...
    <main>
        <div class="dhp_produkt5">
            <img id="dhp_produkti5" class="zoomin" src="../../images/imgdhpunes/shelf.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12350p</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Denes</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">You can now stack all the books you want!</td>
                    </tr>
                    <tr>
