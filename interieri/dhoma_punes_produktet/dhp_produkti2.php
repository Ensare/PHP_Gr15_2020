...
<body>
    ...
    <main>
<div class="dhp_produkt1">
    <img id="dhp_produkti1" class="zoomin" src="../../images/imgdhpunes/bigworktable.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
        <thead>
            <tr>
                <td class="pad">Product ID</td>
                <td class="pad">12346p</td>
            </tr>
        </thead>
        <tbody>
            <tr>
            <td class="pad">Product Name</td>
            <td class="pad">Oisin</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="pad">For your next office meeting. </td>
        </tr>
        <tr>
