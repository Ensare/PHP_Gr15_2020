...
<body>
    ...
    <main>
        <div class="dhp_produkt3">
            <img id="dhp_produkti3" class="zoomin" src="../../images/imgdhpunes/beanbags.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12347p</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Palma</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">Perfect spot to rest, work or learn. </td>
                    </tr>
                    <tr>
