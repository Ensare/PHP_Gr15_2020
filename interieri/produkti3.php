...
<body>
    ...
    <main>
        ...
        <div class="kuzhina_produkti3">
            <img id="kuzhina_produkti3" class="zoomin" src="../../images/imgkuzhina/c.jpg" style="width: 490px; height: 350px">
            <table border="1" class="tabela">
                <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">78459c</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Zobel and Co Kitchen</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">1500$</td class="pad">
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Kitchen the heart of the home.</td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="../../porosit_online.html">Buy it online!</a> </td>
                    </tr>
                </tbody>
            </table>
        </br>
