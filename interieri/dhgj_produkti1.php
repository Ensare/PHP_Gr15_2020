...
<body>
    ...
    <main>
<div class="dhgj_produkti1">
    <img id="dhgj_produkti1" class="zoomin" src="../../images/imggjumi/dhgj1.jpeg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
          <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">12467a</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Celya</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pad">Everything starts with a dream. </td>
                    </tr>
                    <tr>
