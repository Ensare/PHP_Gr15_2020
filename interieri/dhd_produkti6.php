...
<body>
    ...
    <main>
        <div class="dhd_produkti6">
         <img id="dhd_produkti6" class="zoomin" src="../../images/imgdhdites/dhd_produkti6.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
       <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">54286e</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Starmore</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">10000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Sit long, talk much, laugh offen </td>
                    </tr>
                    <tr>
