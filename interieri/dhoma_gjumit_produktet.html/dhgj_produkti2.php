...
<body>
    ...
    <main>
<div class="dhgj_produkti2">
    <img id="dhgj_produkti2" class="zoomin"src="../../images/imggjumi/dhgj2.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
         <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">92965b</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Mattress</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">2090$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Always and forever. </td>
                    </tr>
                    <tr>
