...
<body>
    ...
    <main>
<div class="dhgj_produkti5">
    <img id="dhgj_produkti5" class="zoomin" src="../../images/imggjumi/dhgj5.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
        <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">88739f</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Tuft and Needle</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">3000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Chill here. </td>
                    </tr>
                    <tr>
