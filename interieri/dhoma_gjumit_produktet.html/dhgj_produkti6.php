...
<body>
    ...
    <main>
<div class="dhgj_produkti6">
    <img id="dhgj_produkti6" class="zoomin" src="../../images/imggjumi/dhgj6.jpg" style="width: 490px; height: 350px">
    <table border="1" class="tabela">
       <thead>
                    <tr>
                        <td class="pad">Product ID</td>
                        <td class="pad">543456e</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pad">Product Name</td>
                        <td class="pad">Effie</td>
                    </tr>
                    <tr>
                        <td class="pad">Price</td>
                        <td class="pad">6000$</td>
                    </tr>
                    <tr>
                        <td class="pad"> Description</td>
                        <td class="pad">Wake up and makeup.</td>
                    </tr>
                    <tr>
