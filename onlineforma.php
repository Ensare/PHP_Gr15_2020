...
<head en="lang">
    ...
    if ($_POST["form_number"] == "1") {
        $contact = $mobile = $address = $country = $city =  $zip = "";
        $reg = "/^[a-zA-Z\s\d\.]+$/";
        $reg2 = "/\+[0-9]/s";
        $reg3 = "/[0-9]{5}/s";

        if (isset($_POST['submit'])) {
            if (preg_match($reg, $_POST['contact'])) {
            ...
            if (preg_match($reg2, $_POST['mobile'])) {
            ...
            if (preg_match($reg, $_POST['address'])) {
            ...
            if (preg_match($reg, $_POST['country'])) {
...
<body>
    ...
    <form method="POST" id="mainForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <tr>
                    <td>
                        <p>
                            ...
                            <input class="g" type="tel" name="mobile" id="mobnm" /><br />
                            <?php if (isset($mobile)) {
                                echo $mobile;
                            } ?><br /><br />
                ...
                <tr>
                    <td>
                        <p>
                            ...
                            <input type="text" class="g type=" name="address" id="addr" /><br />
                ...
                <tr>
                    <td>
                        ...
                        <p>
                            ...
                            <input class="g" type="text" name="city" id="city" /><br />
                            <?php if (isset($city)) {
                                echo $city;
                            } ?><br /><br />
                        </p>
                ...
                <tr>
                    <td>
                        <p>
                            ...
                            <input class="g" type="text" name="zip" placeholder="Zip code" maxlength="5" minlength="5" /><br />
                            <?php if (isset($zip)) {
                                echo $zip;
                            } ?><br /><br />
                        </p>
                    ...
                    <td>
                        <div class="confirmi">
                            ...
                            <input type="submit" name="submit" class="btn" value="Confirm" id="conf">
