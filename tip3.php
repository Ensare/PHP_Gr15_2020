...
<body>
    ...
    <article class="parent">
        <img id="div2" src="images/imgtat/id3.jpg" width="550px" height="550px">
        <p id="div1"> Vibrant bursts of color are great to bring life to any room in your home.
            However, the rule of thumb is to use them as accent pieces, not as the entire room décor.
            Consider using throw pillows on your neutral colored couch to bring in the colors of the season.
            You can use vibrant yellow and orange during summer or beautiful reds and browns in the fall.
            You can also paint an accent wall a bold color while the rest of the walls are more neutral.

        </p>
        <img id="div3" src="images/imgtat/tip3.jpg" width="550px" height="550px">
        <p id="div4">It is always great to bring in a historical timeless element such as Amish furniture.
            These pieces are built with high-quality materials by experienced carpenters.
            Place a beautifully crafted Amish bookcase in your bedroom or office to house your trinkets and favorite
            books.These are just a few of the timeless interior design ideas available for your home. There are many
            more to choose from.
            The options are as varied as your personality and will fit it just the same! </p>
        <img id="div6" src="images/imgtat/tip4.jpg" width="550px" height="550px">
        <p id="div5"> Another way to decorate that never goes out of style is with different types of fabric in your
            rooms.
            You can add a rug of a vibrant color or pattern to your family room tile or hardwood floor.
            You can install curtains with beautiful sheik designs for your master bedroom or guest bedroom areas.
            You can even install these fabrics and colors into your bathroom areas so that you can change up the
            style whenever you like.
            This is one element of timeless interior design that allows you to change your style choice up
            regularly, without breaking the bank.</p>
        <img id="div7" src="images/imgtat/tip32.jpg" width="550px" height="550px">
        <p id="div8">The interior design of your home speaks volumes. Not only does it showcase style and class, it
            can also be an extension of your personality.
            While design ideas come and go, there are a few that are simply timeless and never go out of style.
            Check out the timeless interior design ideas below for your home to showcase your personality
            and bring a fresh breath of life to your master bedroom, family room, or any room in your home.</p>
        <img id="div10" src="images/imgtat/tip33.jpg" width="550px" height="550px">
        <p id="div9">One timeless trend that never goes away is the neutral interior color design option.
            Neutrals are always a classic way to decorate your home, whether in paint colors or in the décor items
            themselves.
            The neutral tones are always a style you can count on and they give the room a fresh, clean look at all
            times. Remember,
            if you feel like it’s not enough color, you can always add it in as mentioned in the above tip.</p>
    </article>
